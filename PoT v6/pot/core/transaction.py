"""
PoT Protocol v6 Transaction Structure
...
from pot.core.serialization import ByteReader, ByteWriter, pad_to_size
...
class Transaction:
    ...
    def create(
        ...
        """
        from pot.constants import TX_EPOCH_DURATION_SEC
        from pot.core.types import empty_signature
