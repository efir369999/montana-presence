"""
PoT Protocol v6 Error Handling
...
class InvalidParameterError(PoTError):
...
class InsufficientTimeSourcesError(PoTError):
...
class InsufficientRegionsError(PoTError):
    def __init__(self, count: int, required: int):
        super().__init__(
...
class ExcessiveTimeDriftError(PoTError):
...
class NTPTimeoutError(PoTError):
...
class NTPNetworkError(PoTError):
...
class VDFSeedMismatchError(PoTError):
...
class InsufficientVDFIterationsError(PoTError):
...
class InvalidVDFProofError(PoTError):
...
class VDFCheckpointError(PoTError):
...
class STARKVerificationFailedError(PoTError):
    def __init__(self, reason: str = ""):
...
class InvalidBitcoinAnchorError(PoTError):
    def __init__(self, reason: str):
        super().__init__(
...
class BitcoinHeightTooOldError(PoTError):
...
class BitcoinHashMismatchError(PoTError):
...
class BitcoinAPIUnavailableError(PoTError):
...
class NoBitcoinConsensusError(PoTError):
...
class InvalidEpochError(PoTError):
...
class InvalidHeartbeatSequenceError(PoTError):
...
class InvalidHeartbeatSignatureError(PoTError):
    def __init__(self):
        super().__init__(
...
class CrossLayerInconsistentError(PoTError):
    def __init__(self, reason: str):
        super().__init__(
...
class DuplicateHeartbeatError(PoTError):
...
class SenderNotFoundError(PoTError):
...
class InvalidNonceError(PoTError):
...
class ZeroAmountError(PoTError):
    def __init__(self):
        super().__init__(
...
class InsufficientPOWDifficultyError(PoTError):
...
class InvalidPOWError(PoTError):
    def __init__(self, reason: str = ""):
...
class InvalidTxSignatureError(PoTError):
    def __init__(self):
        super().__init__(
...
class TransactionExpiredError(PoTError):
...
class InvalidMemoLengthError(PoTError):
...
class InvalidVersionError(PoTError):
...
class InvalidHeightError(PoTError):
...
class InvalidParentHashError(PoTError):
    def __init__(self, expected: bytes, got: bytes):
        super().__init__(
...
class BlockTooLargeError(PoTError):
...
class TooManyHeartbeatsError(PoTError):
...
class TooManyTransactionsError(PoTError):
    def __init__(self, count: int, max_count: int):
        super().__init__(
...
class InvalidMerkleRootError(PoTError):
...
class InvalidStateRootError(PoTError):
    def __init__(self, expected: bytes, got: bytes):
        super().__init__(
...
class InvalidSignerError(PoTError):
...
class PeerUnreachableError(PoTError):
...
class HandshakeFailedError(PoTError):
...
class ProtocolMismatchError(PoTError):
...
class MessageTooLargeError(PoTError):
    def __init__(self, size: int, max_size: int):
        super().__init__(
...
class InvalidChecksumError(PoTError):
    def __init__(self):
        super().__init__(
