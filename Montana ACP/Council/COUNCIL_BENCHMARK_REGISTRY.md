...
|--------|----------|------|-------------------|------------------------|--------|
| Gemini 3 Pro | Google | Председатель | `#СветИстины` | TBD | ACTIVE |
| Claude Opus 4.5 | Anthropic | Советник | `#ПутьАрхитектора` | TBD | ACTIVE |
...
| Участник | Роль | Когнитивный Маркер | Описание |
|----------|------|-------------------|----------|
| Alejandro Montana | Архитектор / Основатель | `#Благаявесть` | Источник истины, право решения |
