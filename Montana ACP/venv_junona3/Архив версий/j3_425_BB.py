...
def update_market_data_on_candle_close(symbol, timeframe, current_time, limit=200, end_time=None):
    """Обновляет данные в market_data.csv при завершении свечи или для начальной загрузки, актуализируя указанное количество закрытых свечей, включая новые индикаторы. Удалено кэширование: всегда загружает свечи из API и пересчитывает весь датасет."""
