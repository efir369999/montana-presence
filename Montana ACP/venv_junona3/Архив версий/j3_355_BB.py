...
# Получение API-ключей из Keychain
BYBIT_API_KEY = keyring.get_password("bybit_api_key", "CopyPro")
BYBIT_API_SECRET = keyring.get_password("bybit_api_secret", "CopyPro")

# Проверка наличия ключей
if BYBIT_API_KEY is None or BYBIT_API_SECRET is None:
    raise Exception("Не удалось получить API-ключи из Keychain. Убедитесь, что они сохранены с помощью keyring.set_password().")
