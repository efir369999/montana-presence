"""
ATC Protocol v7 Validation Rules
...
from atc.crypto.sphincs import sphincs_verify
from atc.crypto.pow import verify_transaction_pow, get_personal_difficulty
from atc.crypto.merkle import merkle_root
from atc.crypto.vdf import verify_vdf
from atc.consensus.score import compute_score, effective_score
...
def validate_heartbeat_layer1(
    ...
    - VDF proof is valid
    """
    from atc.crypto.vdf import generate_vdf_seed
