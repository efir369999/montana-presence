...
from atc.crypto.hash import sha3_256, sha3_256_raw
...
class MerkleProof:
    ...
    def serialize(self) -> bytes:
        ...
        from atc.core.serialization import serialize_varint
    ...
    def deserialize(cls, data: bytes, offset: int = 0) -> Tuple["MerkleProof", int]:
        ...
        from atc.core.serialization import deserialize_varint
